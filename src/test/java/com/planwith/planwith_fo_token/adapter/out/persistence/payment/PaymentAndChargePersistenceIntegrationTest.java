...
class PaymentAndChargePersistenceIntegrationTest {
	...
	void savesPaymentMethodAndChargeLinkedToLedgerUuid() {
		...
		UUID paymentMethodUuid = UUID.fromString("44444444-4444-4444-4444-444444444444");
		UUID chargeUuid = UUID.fromString("55555555-5555-5555-5555-555555555555");
		UUID ledgerUuid = UUID.fromString("66666666-6666-6666-6666-666666666666");
		...
		assertThat(tokenChargePort.findByChargeUuid(chargeUuid)).isPresent();
	}
}
